...
public class SimpleRequisitionListItemQuery extends AbstractQuery<SimpleRequisitionListItemQuery> {
    SimpleRequisitionListItemQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
     ...
     */
    public SimpleRequisitionListItemQuery customizableOptions(SelectedCustomizableOptionQueryDefinition queryDef) {
     ...
     */
    public SimpleRequisitionListItemQuery product(ProductInterfaceQueryDefinition queryDef) {
        startField("product");
     ...
     */
    public static Fragment<SimpleRequisitionListItemQuery> createFragment(String name, SimpleRequisitionListItemQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new SimpleRequisitionListItemQuery(sb));
        return new Fragment<>(name, "SimpleRequisitionListItem", sb.toString());
    }

    /**
     * Adds a <code>SimpleRequisitionListItemQuery</code> fragment reference at the current position of the query.
     ...
     * @param fragment The fragment to reference.
     */
    public SimpleRequisitionListItemQuery addRequisitionListItemInterfaceFragmentReference(
