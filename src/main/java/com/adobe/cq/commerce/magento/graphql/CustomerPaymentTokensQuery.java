...
public class CustomerPaymentTokensQuery extends AbstractQuery<CustomerPaymentTokensQuery> {
     ...
     */
    public static Fragment<CustomerPaymentTokensQuery> createFragment(String name, CustomerPaymentTokensQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new CustomerPaymentTokensQuery(sb));
        return new Fragment<>(name, "CustomerPaymentTokens", sb.toString());
    }

    /**
     * Adds a <code>CustomerPaymentTokensQuery</code> fragment reference at the current position of the query.
