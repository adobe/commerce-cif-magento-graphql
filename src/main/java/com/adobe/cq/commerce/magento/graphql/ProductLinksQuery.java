...
public class ProductLinksQuery extends AbstractQuery<ProductLinksQuery> {
     ...
     */
    public static Fragment<ProductLinksQuery> createFragment(String name, ProductLinksQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new ProductLinksQuery(sb));
        return new Fragment<>(name, "ProductLinks", sb.toString());
    }

    /**
     * Adds a <code>ProductLinksQuery</code> fragment reference at the current position of the query.
