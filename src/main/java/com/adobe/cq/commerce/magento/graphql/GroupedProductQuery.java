...
public class GroupedProductQuery extends AbstractQuery<GroupedProductQuery> {
     ...
     */
    public GroupedProductQuery reviews(ProductReviewsQueryDefinition queryDef) {
     ...
     * The list of products reviews.
     */
    public GroupedProductQuery reviews(ReviewsArgumentsDefinition argsDef, ProductReviewsQueryDefinition queryDef) {
        startField("reviews");
