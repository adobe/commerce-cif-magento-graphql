...
public class BundleWishlistItemQuery extends AbstractQuery<BundleWishlistItemQuery> {
     ...
     */
    public static Fragment<BundleWishlistItemQuery> createFragment(String name, BundleWishlistItemQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new BundleWishlistItemQuery(sb));
        return new Fragment<>(name, "BundleWishlistItem", sb.toString());
    }

    /**
     * Adds a <code>BundleWishlistItemQuery</code> fragment reference at the current position of the query.
     ...
     */
    public BundleWishlistItemQuery addFragmentReference(Fragment<BundleWishlistItemQuery> fragment) {
     ...
     * @param fragment The fragment to reference.
     */
    public BundleWishlistItemQuery addWishlistItemInterfaceFragmentReference(Fragment<WishlistItemInterfaceQuery> fragment) {
        startField("..." + fragment.getName());
        return this;
    }
}
