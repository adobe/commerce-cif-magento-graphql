...
public class GiftCardOrderItem extends AbstractResponse<GiftCardOrderItem> implements OrderItemInterface {
    public GiftCardOrderItem() {
    }

    public GiftCardOrderItem(JsonObject fields) throws SchemaViolationError {
    ...
    public GiftCardOrderItem setDiscounts(List<Discount> arg) {
    ...
    public GiftCardOrderItem setEnteredOptions(List<OrderItemOption> arg) {
    ...
    public GiftCardOrderItem setGiftCard(GiftCardItem arg) {
    ...
    public GiftCardOrderItem setGiftWrapping(GiftWrapping arg) {
    ...
    public GiftCardOrderItem setId(ID arg) {
    ...
    public GiftCardOrderItem setProductName(String arg) {
    ...
    public GiftCardOrderItem setProductSalePrice(Money arg) {
    ...
    public GiftCardOrderItem setProductSku(String arg) {
    ...
    public GiftCardOrderItem setProductType(String arg) {
    ...
    public GiftCardOrderItem setProductUrlKey(String arg) {
    ...
    public GiftCardOrderItem setQuantityCanceled(Double arg) {
    ...
    public GiftCardOrderItem setQuantityInvoiced(Double arg) {
    ...
    public GiftCardOrderItem setQuantityOrdered(Double arg) {
    ...
    public GiftCardOrderItem setQuantityRefunded(Double arg) {
    ...
    public GiftCardOrderItem setQuantityReturned(Double arg) {
    ...
    public GiftCardOrderItem setQuantityShipped(Double arg) {
    ...
    public GiftCardOrderItem setSelectedOptions(List<OrderItemOption> arg) {
    ...
    public GiftCardOrderItem setStatus(String arg) {
