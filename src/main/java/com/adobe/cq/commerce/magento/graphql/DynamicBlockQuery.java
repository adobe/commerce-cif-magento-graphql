...
public class DynamicBlockQuery extends AbstractQuery<DynamicBlockQuery> {
     ...
     */
    public static Fragment<DynamicBlockQuery> createFragment(String name, DynamicBlockQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new DynamicBlockQuery(sb));
        return new Fragment<>(name, "DynamicBlock", sb.toString());
    }

    /**
     * Adds a <code>DynamicBlockQuery</code> fragment reference at the current position of the query.
