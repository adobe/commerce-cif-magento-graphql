...
public class RewardPointsRateQuery extends AbstractQuery<RewardPointsRateQuery> {
     ...
     */
    public static Fragment<RewardPointsRateQuery> createFragment(String name, RewardPointsRateQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new RewardPointsRateQuery(sb));
        return new Fragment<>(name, "RewardPointsRate", sb.toString());
    }

    /**
     * Adds a <code>RewardPointsRateQuery</code> fragment reference at the current position of the query.
