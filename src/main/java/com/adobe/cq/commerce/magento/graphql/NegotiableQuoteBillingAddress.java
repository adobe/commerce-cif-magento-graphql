...
public class NegotiableQuoteBillingAddress extends AbstractResponse<NegotiableQuoteBillingAddress> implements
    NegotiableQuoteAddressInterface {
    public NegotiableQuoteBillingAddress() {}

    public NegotiableQuoteBillingAddress(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "NegotiableQuoteBillingAddress";
    }
    ...
    public NegotiableQuoteBillingAddress setCity(String arg) {
    ...
    public NegotiableQuoteBillingAddress setCompany(String arg) {
    ...
    public NegotiableQuoteBillingAddress setCountry(NegotiableQuoteAddressCountry arg) {
    ...
    public NegotiableQuoteBillingAddress setFirstname(String arg) {
    ...
    public NegotiableQuoteBillingAddress setLastname(String arg) {
    ...
    public NegotiableQuoteBillingAddress setPostcode(String arg) {
    ...
    public NegotiableQuoteBillingAddress setRegion(NegotiableQuoteAddressRegion arg) {
    ...
    public NegotiableQuoteBillingAddress setStreet(List<String> arg) {
    ...
    public NegotiableQuoteBillingAddress setTelephone(String arg) {
