...
public class ColorSwatchDataQuery extends AbstractQuery<ColorSwatchDataQuery> {
     ...
     */
    public static Fragment<ColorSwatchDataQuery> createFragment(String name, ColorSwatchDataQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new ColorSwatchDataQuery(sb));
        return new Fragment<>(name, "ColorSwatchData", sb.toString());
    }

    /**
     * Adds a <code>ColorSwatchDataQuery</code> fragment reference at the current position of the query.
