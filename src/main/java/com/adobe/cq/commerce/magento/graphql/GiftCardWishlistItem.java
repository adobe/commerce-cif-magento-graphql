...
public class GiftCardWishlistItem extends AbstractResponse<GiftCardWishlistItem> implements WishlistItemInterface {
    ...
    public GiftCardWishlistItem(JsonObject fields) throws SchemaViolationError {
    ...
    public GiftCardWishlistItem setAddedAt(String arg) {
    ...
    public GiftCardWishlistItem setCustomizableOptions(List<SelectedCustomizableOption> arg) {
    ...
    public GiftCardWishlistItem setDescription(String arg) {
    ...
    public GiftCardWishlistItem setGiftCardOptions(GiftCardOptions arg) {
    ...
    public GiftCardWishlistItem setId(ID arg) {
    ...
    public GiftCardWishlistItem setProduct(ProductInterface arg) {
    ...
    public GiftCardWishlistItem setQuantity(Double arg) {
