...
public class ComparableAttribute extends AbstractResponse<ComparableAttribute> {
    ...
    public ComparableAttribute(JsonObject fields) throws SchemaViolationError {
    ...
    public ComparableAttribute setCode(String arg) {
    ...
    public ComparableAttribute setLabel(String arg) {
