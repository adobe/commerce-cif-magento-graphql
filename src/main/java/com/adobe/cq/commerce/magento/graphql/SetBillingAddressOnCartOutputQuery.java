...
public class SetBillingAddressOnCartOutputQuery extends AbstractQuery<SetBillingAddressOnCartOutputQuery> {
    ...
    /**
     * Adds a <code>SetBillingAddressOnCartOutputQuery</code> fragment reference at the current position of the query.
     ...
     */
    public SetBillingAddressOnCartOutputQuery addFragmentReference(Fragment<SetBillingAddressOnCartOutputQuery> fragment) {
