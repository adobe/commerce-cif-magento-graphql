...
public class NegotiableQuoteUidNonFatalResultInterfaceQuery extends AbstractQuery<NegotiableQuoteUidNonFatalResultInterfaceQuery> {
    NegotiableQuoteUidNonFatalResultInterfaceQuery(StringBuilder _queryBuilder) {
        this(_queryBuilder, true);
    }

    NegotiableQuoteUidNonFatalResultInterfaceQuery(StringBuilder _queryBuilder, boolean addTypename) {
        super(_queryBuilder);
        if (addTypename) {
    ...
    public NegotiableQuoteUidNonFatalResultInterfaceQuery onNegotiableQuoteUidOperationSuccess(
     ...
     */
    public static Fragment<NegotiableQuoteUidNonFatalResultInterfaceQuery> createFragment(String name,
        NegotiableQuoteUidNonFatalResultInterfaceQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new NegotiableQuoteUidNonFatalResultInterfaceQuery(sb, false));
        return new Fragment<>(name, "NegotiableQuoteUidNonFatalResultInterface", sb.toString());
    }
     ...
     */
    public NegotiableQuoteUidNonFatalResultInterfaceQuery addFragmentReference(
