...
public class BundleCartItem extends AbstractResponse<BundleCartItem> implements CartItemInterface {
    ...
    public BundleCartItem setAvailableGiftWrapping(List<GiftWrapping> arg) {
    ...
    public BundleCartItem setGiftMessage(GiftMessage arg) {
    ...
    public BundleCartItem setGiftWrapping(GiftWrapping arg) {
