...
public class UpdateGiftRegistryRegistrantsOutput extends AbstractResponse<UpdateGiftRegistryRegistrantsOutput> {
    ...
    public UpdateGiftRegistryRegistrantsOutput(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "UpdateGiftRegistryRegistrantsOutput";
    }
    ...
    public UpdateGiftRegistryRegistrantsOutput setGiftRegistry(GiftRegistry arg) {
