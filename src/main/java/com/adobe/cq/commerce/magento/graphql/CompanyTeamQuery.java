...
public class CompanyTeamQuery extends AbstractQuery<CompanyTeamQuery> {
    CompanyTeamQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
     ...
     */
    public static Fragment<CompanyTeamQuery> createFragment(String name, CompanyTeamQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new CompanyTeamQuery(sb));
        return new Fragment<>(name, "CompanyTeam", sb.toString());
    }

    /**
     * Adds a <code>CompanyTeamQuery</code> fragment reference at the current position of the query.
