...
public class VirtualProduct extends AbstractResponse<VirtualProduct> implements CustomizableProductInterface, ProductInterface,
    ...
    public VirtualProduct setIsReturnable(String arg) {
    ...
    public VirtualProduct setPriceRange(PriceRange arg) {
    ...
    public VirtualProduct setPriceTiers(List<TierPrice> arg) {
    ...
    public VirtualProduct setRatingSummary(Double arg) {
    ...
    public VirtualProduct setReviewCount(Integer arg) {
    ...
    public VirtualProduct setReviews(ProductReviews arg) {
    ...
    public VirtualProduct setStaged(Boolean arg) {
    ...
    public VirtualProduct setUid(ID arg) {
    ...
    public VirtualProduct setUrlSuffix(String arg) {
