...
public class MoveCartItemsToGiftRegistryOutputQuery extends AbstractQuery<MoveCartItemsToGiftRegistryOutputQuery> {
     ...
     */
    public static Fragment<MoveCartItemsToGiftRegistryOutputQuery> createFragment(String name,
        MoveCartItemsToGiftRegistryOutputQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new MoveCartItemsToGiftRegistryOutputQuery(sb));
        return new Fragment<>(name, "MoveCartItemsToGiftRegistryOutput", sb.toString());
    }

    /**
     * Adds a <code>MoveCartItemsToGiftRegistryOutputQuery</code> fragment reference at the current position of the query.
     ...
     * @param fragment The fragment to reference.
     */
    public MoveCartItemsToGiftRegistryOutputQuery addGiftRegistryItemUserErrorInterfaceFragmentReference(
        Fragment<GiftRegistryItemUserErrorInterfaceQuery> fragment) {
        startField("..." + fragment.getName());
        return this;
    }
     ...
     * @param fragment The fragment to reference.
     */
    public MoveCartItemsToGiftRegistryOutputQuery addGiftRegistryOutputInterfaceFragmentReference(
        Fragment<GiftRegistryOutputInterfaceQuery> fragment) {
        startField("..." + fragment.getName());
        return this;
    }
}
