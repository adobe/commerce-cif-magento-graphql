...
public class DownloadableWishlistItemQuery extends AbstractQuery<DownloadableWishlistItemQuery> {
     ...
     */
    public static Fragment<DownloadableWishlistItemQuery> createFragment(String name, DownloadableWishlistItemQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new DownloadableWishlistItemQuery(sb));
        return new Fragment<>(name, "DownloadableWishlistItem", sb.toString());
    }

    /**
     * Adds a <code>DownloadableWishlistItemQuery</code> fragment reference at the current position of the query.
     ...
     */
    public DownloadableWishlistItemQuery addFragmentReference(Fragment<DownloadableWishlistItemQuery> fragment) {
     ...
     * @param fragment The fragment to reference.
     */
    public DownloadableWishlistItemQuery addWishlistItemInterfaceFragmentReference(Fragment<WishlistItemInterfaceQuery> fragment) {
        startField("..." + fragment.getName());
        return this;
    }
}
