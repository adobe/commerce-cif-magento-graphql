...
public class CustomizableFileValueQuery extends AbstractQuery<CustomizableFileValueQuery> {
     ...
     */
    public static Fragment<CustomizableFileValueQuery> createFragment(String name, CustomizableFileValueQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new CustomizableFileValueQuery(sb));
        return new Fragment<>(name, "CustomizableFileValue", sb.toString());
    }

    /**
     * Adds a <code>CustomizableFileValueQuery</code> fragment reference at the current position of the query.
