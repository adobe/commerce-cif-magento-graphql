...
public class CustomizableAreaValueQuery extends AbstractQuery<CustomizableAreaValueQuery> {
     ...
     */
    public static Fragment<CustomizableAreaValueQuery> createFragment(String name, CustomizableAreaValueQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new CustomizableAreaValueQuery(sb));
        return new Fragment<>(name, "CustomizableAreaValue", sb.toString());
    }

    /**
     * Adds a <code>CustomizableAreaValueQuery</code> fragment reference at the current position of the query.
