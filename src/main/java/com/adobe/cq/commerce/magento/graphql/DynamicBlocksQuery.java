...
public class DynamicBlocksQuery extends AbstractQuery<DynamicBlocksQuery> {
    ...
    public DynamicBlocksQuery items(DynamicBlockQueryDefinition queryDef) {
        ...
        queryDef.define(new DynamicBlockQuery(_queryBuilder));
        _queryBuilder.append('}');
     ...
     */
    public static Fragment<DynamicBlocksQuery> createFragment(String name, DynamicBlocksQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new DynamicBlocksQuery(sb));
        return new Fragment<>(name, "DynamicBlocks", sb.toString());
    }

    /**
     * Adds a <code>DynamicBlocksQuery</code> fragment reference at the current position of the query.
