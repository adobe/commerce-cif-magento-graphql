...
public class FixedProductTaxQuery extends AbstractQuery<FixedProductTaxQuery> {
    FixedProductTaxQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
     ...
     */
    public static Fragment<FixedProductTaxQuery> createFragment(String name, FixedProductTaxQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new FixedProductTaxQuery(sb));
        return new Fragment<>(name, "FixedProductTax", sb.toString());
    }

    /**
     * Adds a <code>FixedProductTaxQuery</code> fragment reference at the current position of the query.
