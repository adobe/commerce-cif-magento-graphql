...
public class GiftRegistryDynamicAttributeMetadataInterfaceQuery extends AbstractQuery<GiftRegistryDynamicAttributeMetadataInterfaceQuery> {
    GiftRegistryDynamicAttributeMetadataInterfaceQuery(StringBuilder _queryBuilder) {
        this(_queryBuilder, true);
    }

    GiftRegistryDynamicAttributeMetadataInterfaceQuery(StringBuilder _queryBuilder, boolean addTypename) {
        super(_queryBuilder);
        if (addTypename) {
    ...
    public GiftRegistryDynamicAttributeMetadataInterfaceQuery onGiftRegistryDynamicAttributeMetadata(
        GiftRegistryDynamicAttributeMetadataQueryDefinition queryDef) {
        startInlineFragment("GiftRegistryDynamicAttributeMetadata");
        queryDef.define(new GiftRegistryDynamicAttributeMetadataQuery(_queryBuilder));
     ...
     */
    public static Fragment<GiftRegistryDynamicAttributeMetadataInterfaceQuery> createFragment(String name,
        GiftRegistryDynamicAttributeMetadataInterfaceQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new GiftRegistryDynamicAttributeMetadataInterfaceQuery(sb, false));
        return new Fragment<>(name, "GiftRegistryDynamicAttributeMetadataInterface", sb.toString());
    }
     ...
     */
    public GiftRegistryDynamicAttributeMetadataInterfaceQuery addFragmentReference(
