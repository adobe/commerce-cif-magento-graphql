...
public class CompanyAclResourceQuery extends AbstractQuery<CompanyAclResourceQuery> {
    CompanyAclResourceQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
     ...
     */
    public CompanyAclResourceQuery children(CompanyAclResourceQueryDefinition queryDef) {
        startField("children");
     ...
     */
    public static Fragment<CompanyAclResourceQuery> createFragment(String name, CompanyAclResourceQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new CompanyAclResourceQuery(sb));
        return new Fragment<>(name, "CompanyAclResource", sb.toString());
    }

    /**
     * Adds a <code>CompanyAclResourceQuery</code> fragment reference at the current position of the query.
