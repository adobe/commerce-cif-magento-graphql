...
public class AddReturnTrackingOutputQuery extends AbstractQuery<AddReturnTrackingOutputQuery> {
     ...
     */
    public static Fragment<AddReturnTrackingOutputQuery> createFragment(String name, AddReturnTrackingOutputQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new AddReturnTrackingOutputQuery(sb));
        return new Fragment<>(name, "AddReturnTrackingOutput", sb.toString());
    }

    /**
     * Adds a <code>AddReturnTrackingOutputQuery</code> fragment reference at the current position of the query.
