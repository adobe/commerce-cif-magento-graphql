...
public class ConfigurableProductOptionQuery extends AbstractQuery<ConfigurableProductOptionQuery> {
    ...
    public ConfigurableProductOptionQuery values(ConfigurableProductOptionValueQueryDefinition queryDef) {
        ...
        queryDef.define(new ConfigurableProductOptionValueQuery(_queryBuilder));
        _queryBuilder.append('}');
     ...
     */
    public static Fragment<ConfigurableProductOptionQuery> createFragment(String name, ConfigurableProductOptionQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new ConfigurableProductOptionQuery(sb));
        return new Fragment<>(name, "ConfigurableProductOption", sb.toString());
    }

    /**
     * Adds a <code>ConfigurableProductOptionQuery</code> fragment reference at the current position of the query.
