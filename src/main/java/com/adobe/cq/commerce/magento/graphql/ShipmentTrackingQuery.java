...
public class ShipmentTrackingQuery extends AbstractQuery<ShipmentTrackingQuery> {
     ...
     */
    public static Fragment<ShipmentTrackingQuery> createFragment(String name, ShipmentTrackingQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new ShipmentTrackingQuery(sb));
        return new Fragment<>(name, "ShipmentTracking", sb.toString());
    }

    /**
     * Adds a <code>ShipmentTrackingQuery</code> fragment reference at the current position of the query.
