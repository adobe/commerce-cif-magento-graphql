...
public class ConfigurableWishlistItem extends AbstractResponse<ConfigurableWishlistItem> implements WishlistItemInterface {
    ...
    public ConfigurableWishlistItem(JsonObject fields) throws SchemaViolationError {
    ...
    public ConfigurableWishlistItem setAddedAt(String arg) {
    ...
    public ConfigurableWishlistItem setChildSku(String arg) {
        optimisticData.put(getKey("child_sku"), arg);
        return this;
    }
    ...
    public ConfigurableWishlistItem setConfigurableOptions(List<SelectedConfigurableOption> arg) {
    ...
    public ConfigurableWishlistItem setCustomizableOptions(List<SelectedCustomizableOption> arg) {
    ...
    public ConfigurableWishlistItem setDescription(String arg) {
    ...
    public ConfigurableWishlistItem setId(ID arg) {
    ...
    public ConfigurableWishlistItem setProduct(ProductInterface arg) {
    ...
    public ConfigurableWishlistItem setQuantity(Double arg) {
