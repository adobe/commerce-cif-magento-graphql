...
public class TextSwatchDataQuery extends AbstractQuery<TextSwatchDataQuery> {
    TextSwatchDataQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
     ...
     */
    public static Fragment<TextSwatchDataQuery> createFragment(String name, TextSwatchDataQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new TextSwatchDataQuery(sb));
        return new Fragment<>(name, "TextSwatchData", sb.toString());
    }

    /**
     * Adds a <code>TextSwatchDataQuery</code> fragment reference at the current position of the query.
