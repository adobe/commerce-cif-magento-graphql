...
public class NegotiableQuoteCommentQuery extends AbstractQuery<NegotiableQuoteCommentQuery> {
    NegotiableQuoteCommentQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
     ...
     */
    public NegotiableQuoteCommentQuery author(NegotiableQuoteUserQueryDefinition queryDef) {
        startField("author");
     ...
     */
    public static Fragment<NegotiableQuoteCommentQuery> createFragment(String name, NegotiableQuoteCommentQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new NegotiableQuoteCommentQuery(sb));
        return new Fragment<>(name, "NegotiableQuoteComment", sb.toString());
    }

    /**
     * Adds a <code>NegotiableQuoteCommentQuery</code> fragment reference at the current position of the query.
