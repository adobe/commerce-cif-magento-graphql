...
public class IsCompanyAdminEmailAvailableOutputQuery extends AbstractQuery<IsCompanyAdminEmailAvailableOutputQuery> {
    IsCompanyAdminEmailAvailableOutputQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
     ...
     */
    public static Fragment<IsCompanyAdminEmailAvailableOutputQuery> createFragment(String name,
        IsCompanyAdminEmailAvailableOutputQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new IsCompanyAdminEmailAvailableOutputQuery(sb));
        return new Fragment<>(name, "IsCompanyAdminEmailAvailableOutput", sb.toString());
    }

    /**
     * Adds a <code>IsCompanyAdminEmailAvailableOutputQuery</code> fragment reference at the current position of the query.
