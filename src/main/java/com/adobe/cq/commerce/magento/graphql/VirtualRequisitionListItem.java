 ...
 */
public class VirtualRequisitionListItem extends AbstractResponse<VirtualRequisitionListItem> implements RequisitionListItemInterface {
    public VirtualRequisitionListItem() {}

    public VirtualRequisitionListItem(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "VirtualRequisitionListItem";
    }
    ...
    public VirtualRequisitionListItem setCustomizableOptions(List<SelectedCustomizableOption> arg) {
    ...
    public VirtualRequisitionListItem setProduct(ProductInterface arg) {
    ...
    public VirtualRequisitionListItem setQuantity(Double arg) {
    ...
    public VirtualRequisitionListItem setUid(ID arg) {
