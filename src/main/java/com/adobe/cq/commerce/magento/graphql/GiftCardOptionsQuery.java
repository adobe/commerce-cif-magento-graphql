...
public class GiftCardOptionsQuery extends AbstractQuery<GiftCardOptionsQuery> {
     ...
     */
    public static Fragment<GiftCardOptionsQuery> createFragment(String name, GiftCardOptionsQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new GiftCardOptionsQuery(sb));
        return new Fragment<>(name, "GiftCardOptions", sb.toString());
    }

    /**
     * Adds a <code>GiftCardOptionsQuery</code> fragment reference at the current position of the query.
