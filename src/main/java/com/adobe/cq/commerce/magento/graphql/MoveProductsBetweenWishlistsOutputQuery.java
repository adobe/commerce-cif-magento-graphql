...
public class MoveProductsBetweenWishlistsOutputQuery extends AbstractQuery<MoveProductsBetweenWishlistsOutputQuery> {
     ...
     */
    public static Fragment<MoveProductsBetweenWishlistsOutputQuery> createFragment(String name,
        MoveProductsBetweenWishlistsOutputQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new MoveProductsBetweenWishlistsOutputQuery(sb));
        return new Fragment<>(name, "MoveProductsBetweenWishlistsOutput", sb.toString());
    }

    /**
     * Adds a <code>MoveProductsBetweenWishlistsOutputQuery</code> fragment reference at the current position of the query.
     ...
     */
    public MoveProductsBetweenWishlistsOutputQuery addFragmentReference(Fragment<MoveProductsBetweenWishlistsOutputQuery> fragment) {
