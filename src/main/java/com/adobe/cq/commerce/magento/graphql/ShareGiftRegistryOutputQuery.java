...
public class ShareGiftRegistryOutputQuery extends AbstractQuery<ShareGiftRegistryOutputQuery> {
     ...
     */
    public static Fragment<ShareGiftRegistryOutputQuery> createFragment(String name, ShareGiftRegistryOutputQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new ShareGiftRegistryOutputQuery(sb));
        return new Fragment<>(name, "ShareGiftRegistryOutput", sb.toString());
    }

    /**
     * Adds a <code>ShareGiftRegistryOutputQuery</code> fragment reference at the current position of the query.
