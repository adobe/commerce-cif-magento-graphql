...
public class CategoryResultQuery extends AbstractQuery<CategoryResultQuery> {
     ...
     */
    public static Fragment<CategoryResultQuery> createFragment(String name, CategoryResultQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new CategoryResultQuery(sb));
        return new Fragment<>(name, "CategoryResult", sb.toString());
    }

    /**
     * Adds a <code>CategoryResultQuery</code> fragment reference at the current position of the query.
     ...
     */
    public CategoryResultQuery addFragmentReference(Fragment<CategoryResultQuery> fragment) {
