...
public class SortFieldsQuery extends AbstractQuery<SortFieldsQuery> {
     ...
     */
    public static Fragment<SortFieldsQuery> createFragment(String name, SortFieldsQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new SortFieldsQuery(sb));
        return new Fragment<>(name, "SortFields", sb.toString());
    }

    /**
     * Adds a <code>SortFieldsQuery</code> fragment reference at the current position of the query.
