...
public class CompanySalesRepresentativeQuery extends AbstractQuery<CompanySalesRepresentativeQuery> {
    CompanySalesRepresentativeQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
     ...
     */
    public static Fragment<CompanySalesRepresentativeQuery> createFragment(String name,
        CompanySalesRepresentativeQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new CompanySalesRepresentativeQuery(sb));
        return new Fragment<>(name, "CompanySalesRepresentative", sb.toString());
    }

    /**
     * Adds a <code>CompanySalesRepresentativeQuery</code> fragment reference at the current position of the query.
