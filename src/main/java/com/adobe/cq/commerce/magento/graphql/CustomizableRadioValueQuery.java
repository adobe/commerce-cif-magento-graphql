...
public class CustomizableRadioValueQuery extends AbstractQuery<CustomizableRadioValueQuery> {
     ...
     */
    public static Fragment<CustomizableRadioValueQuery> createFragment(String name, CustomizableRadioValueQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new CustomizableRadioValueQuery(sb));
        return new Fragment<>(name, "CustomizableRadioValue", sb.toString());
    }

    /**
     * Adds a <code>CustomizableRadioValueQuery</code> fragment reference at the current position of the query.
