...
public class CustomerStoreCreditHistory extends AbstractResponse<CustomerStoreCreditHistory> {
    ...
    public CustomerStoreCreditHistory(JsonObject fields) throws SchemaViolationError {
        for (Map.Entry<String, JsonElement> field : fields.entrySet()) {
            ...
            switch (fieldName) {
                case "items": {
                    List<CustomerStoreCreditHistoryItem> optional1 = null;
                    if (!field.getValue().isJsonNull()) {
                        List<CustomerStoreCreditHistoryItem> list1 = new ArrayList<>();
                        for (JsonElement element1 : jsonAsArray(field.getValue(), key)) {
                            CustomerStoreCreditHistoryItem optional2 = null;
                            if (!element1.isJsonNull()) {
                                optional2 = new CustomerStoreCreditHistoryItem(jsonAsObject(element1, key));
                            }
    ...
    public String getGraphQlTypeName() {
        return "CustomerStoreCreditHistory";
    }

    /**
     * An array containing information about changes to the store credit available to the customer.
     */
    public List<CustomerStoreCreditHistoryItem> getItems() {
        return (List<CustomerStoreCreditHistoryItem>) get("items");
    }

    public CustomerStoreCreditHistory setItems(List<CustomerStoreCreditHistoryItem> arg) {
    ...
    public CustomerStoreCreditHistory setPageInfo(SearchResultPageInfo arg) {
    ...
    public CustomerStoreCreditHistory setTotalCount(Integer arg) {
