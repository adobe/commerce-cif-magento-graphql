...
public class AddVirtualProductsToCartOutputQuery extends AbstractQuery<AddVirtualProductsToCartOutputQuery> {
    ...
    /**
     * Adds a <code>AddVirtualProductsToCartOutputQuery</code> fragment reference at the current position of the query.
     ...
     */
    public AddVirtualProductsToCartOutputQuery addFragmentReference(Fragment<AddVirtualProductsToCartOutputQuery> fragment) {
