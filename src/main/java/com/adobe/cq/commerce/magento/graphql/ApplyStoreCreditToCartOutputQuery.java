...
public class ApplyStoreCreditToCartOutputQuery extends AbstractQuery<ApplyStoreCreditToCartOutputQuery> {
    ...
    /**
     * Adds a <code>ApplyStoreCreditToCartOutputQuery</code> fragment reference at the current position of the query.
     ...
     */
    public ApplyStoreCreditToCartOutputQuery addFragmentReference(Fragment<ApplyStoreCreditToCartOutputQuery> fragment) {
