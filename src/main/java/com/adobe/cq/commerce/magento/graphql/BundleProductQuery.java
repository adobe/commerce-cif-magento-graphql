...
public class BundleProductQuery extends AbstractQuery<BundleProductQuery> {
     ...
     */
    public BundleProductQuery ratingSummary() {
     ...
     */
    public BundleProductQuery reviewCount() {
     ...
     */
    public BundleProductQuery reviews(ProductReviewsQueryDefinition queryDef) {
     ...
     * The list of products reviews.
     */
    public BundleProductQuery reviews(ReviewsArgumentsDefinition argsDef, ProductReviewsQueryDefinition queryDef) {
        startField("reviews");
     ...
     */
    public BundleProductQuery type() {
        startField("type");
     ...
     */
    public static Fragment<BundleProductQuery> createFragment(String name, BundleProductQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new BundleProductQuery(sb));
        return new Fragment<>(name, "BundleProduct", sb.toString());
    }

    /**
     * Adds a <code>BundleProductQuery</code> fragment reference at the current position of the query.
     ...
     */
    public BundleProductQuery addFragmentReference(Fragment<BundleProductQuery> fragment) {
     ...
     * @param fragment The fragment to reference.
     */
    public BundleProductQuery addCustomizableProductInterfaceFragmentReference(Fragment<CustomizableProductInterfaceQuery> fragment) {
        startField("..." + fragment.getName());
        return this;
    }
     ...
     * @param fragment The fragment to reference.
     */
    public BundleProductQuery addPhysicalProductInterfaceFragmentReference(Fragment<PhysicalProductInterfaceQuery> fragment) {
        startField("..." + fragment.getName());
        return this;
    }
     ...
     * @param fragment The fragment to reference.
     */
    public BundleProductQuery addProductInterfaceFragmentReference(Fragment<ProductInterfaceQuery> fragment) {
        startField("..." + fragment.getName());
        return this;
    }
     ...
     * @param fragment The fragment to reference.
     */
    public BundleProductQuery addRoutableInterfaceFragmentReference(Fragment<RoutableInterfaceQuery> fragment) {
        startField("..." + fragment.getName());
        return this;
    }
}
