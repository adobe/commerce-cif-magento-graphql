...
public class RemoveRewardPointsFromCartOutput extends AbstractResponse<RemoveRewardPointsFromCartOutput> {
    ...
    public RemoveRewardPointsFromCartOutput(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "RemoveRewardPointsFromCartOutput";
    }
    ...
    public RemoveRewardPointsFromCartOutput setCart(Cart arg) {
