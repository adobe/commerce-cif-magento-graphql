...
public class CreateGiftRegistryOutput extends AbstractResponse<CreateGiftRegistryOutput> {
    ...
    public CreateGiftRegistryOutput(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "CreateGiftRegistryOutput";
    }
    ...
    public CreateGiftRegistryOutput setGiftRegistry(GiftRegistry arg) {
