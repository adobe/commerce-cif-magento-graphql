...
public class RemoveGiftRegistryRegistrantsOutputQuery extends AbstractQuery<RemoveGiftRegistryRegistrantsOutputQuery> {
     ...
     */
    public static Fragment<RemoveGiftRegistryRegistrantsOutputQuery> createFragment(String name,
        RemoveGiftRegistryRegistrantsOutputQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new RemoveGiftRegistryRegistrantsOutputQuery(sb));
        return new Fragment<>(name, "RemoveGiftRegistryRegistrantsOutput", sb.toString());
    }

    /**
     * Adds a <code>RemoveGiftRegistryRegistrantsOutputQuery</code> fragment reference at the current position of the query.
     ...
     */
    public RemoveGiftRegistryRegistrantsOutputQuery addFragmentReference(Fragment<RemoveGiftRegistryRegistrantsOutputQuery> fragment) {
