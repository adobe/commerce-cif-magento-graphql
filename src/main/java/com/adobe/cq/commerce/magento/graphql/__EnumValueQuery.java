...
public class __EnumValueQuery extends AbstractQuery<__EnumValueQuery> {
     ...
     */
    public static Fragment<__EnumValueQuery> createFragment(String name, __EnumValueQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new __EnumValueQuery(sb));
        return new Fragment<>(name, "__EnumValue", sb.toString());
    }

    /**
     * Adds a <code>__EnumValueQuery</code> fragment reference at the current position of the query.
     ...
     */
    public __EnumValueQuery addFragmentReference(Fragment<__EnumValueQuery> fragment) {
