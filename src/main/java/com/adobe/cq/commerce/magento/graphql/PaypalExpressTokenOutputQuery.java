...
public class PaypalExpressTokenOutputQuery extends AbstractQuery<PaypalExpressTokenOutputQuery> {
     ...
     */
    public static Fragment<PaypalExpressTokenOutputQuery> createFragment(String name, PaypalExpressTokenOutputQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new PaypalExpressTokenOutputQuery(sb));
        return new Fragment<>(name, "PaypalExpressTokenOutput", sb.toString());
    }

    /**
     * Adds a <code>PaypalExpressTokenOutputQuery</code> fragment reference at the current position of the query.
