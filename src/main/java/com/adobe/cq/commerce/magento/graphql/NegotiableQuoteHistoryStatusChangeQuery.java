...
public class NegotiableQuoteHistoryStatusChangeQuery extends AbstractQuery<NegotiableQuoteHistoryStatusChangeQuery> {
    NegotiableQuoteHistoryStatusChangeQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
     ...
     */
    public static Fragment<NegotiableQuoteHistoryStatusChangeQuery> createFragment(String name,
        NegotiableQuoteHistoryStatusChangeQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new NegotiableQuoteHistoryStatusChangeQuery(sb));
        return new Fragment<>(name, "NegotiableQuoteHistoryStatusChange", sb.toString());
    }

    /**
     * Adds a <code>NegotiableQuoteHistoryStatusChangeQuery</code> fragment reference at the current position of the query.
