...
public class ProductPriceQuery extends AbstractQuery<ProductPriceQuery> {
     ...
     */
    public static Fragment<ProductPriceQuery> createFragment(String name, ProductPriceQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new ProductPriceQuery(sb));
        return new Fragment<>(name, "ProductPrice", sb.toString());
    }

    /**
     * Adds a <code>ProductPriceQuery</code> fragment reference at the current position of the query.
