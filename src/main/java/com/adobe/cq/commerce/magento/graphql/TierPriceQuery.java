...
public class TierPriceQuery extends AbstractQuery<TierPriceQuery> {
     ...
     */
    public static Fragment<TierPriceQuery> createFragment(String name, TierPriceQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new TierPriceQuery(sb));
        return new Fragment<>(name, "TierPrice", sb.toString());
    }

    /**
     * Adds a <code>TierPriceQuery</code> fragment reference at the current position of the query.
