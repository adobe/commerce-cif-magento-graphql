...
public class SendFriendConfigurationQuery extends AbstractQuery<SendFriendConfigurationQuery> {
     ...
     */
    public static Fragment<SendFriendConfigurationQuery> createFragment(String name, SendFriendConfigurationQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new SendFriendConfigurationQuery(sb));
        return new Fragment<>(name, "SendFriendConfiguration", sb.toString());
    }

    /**
     * Adds a <code>SendFriendConfigurationQuery</code> fragment reference at the current position of the query.
