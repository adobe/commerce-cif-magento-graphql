...
public class CreateProductReviewOutputQuery extends AbstractQuery<CreateProductReviewOutputQuery> {
     ...
     */
    public static Fragment<CreateProductReviewOutputQuery> createFragment(String name, CreateProductReviewOutputQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new CreateProductReviewOutputQuery(sb));
        return new Fragment<>(name, "CreateProductReviewOutput", sb.toString());
    }

    /**
     * Adds a <code>CreateProductReviewOutputQuery</code> fragment reference at the current position of the query.
