...
public class AppliedGiftCardQuery extends AbstractQuery<AppliedGiftCardQuery> {
     ...
     */
    public static Fragment<AppliedGiftCardQuery> createFragment(String name, AppliedGiftCardQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new AppliedGiftCardQuery(sb));
        return new Fragment<>(name, "AppliedGiftCard", sb.toString());
    }

    /**
     * Adds a <code>AppliedGiftCardQuery</code> fragment reference at the current position of the query.
