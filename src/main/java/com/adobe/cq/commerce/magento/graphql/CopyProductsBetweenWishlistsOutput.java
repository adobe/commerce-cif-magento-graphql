 ...
 */
public class CopyProductsBetweenWishlistsOutput extends AbstractResponse<CopyProductsBetweenWishlistsOutput> {
    public CopyProductsBetweenWishlistsOutput() {}

    public CopyProductsBetweenWishlistsOutput(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "CopyProductsBetweenWishlistsOutput";
    }
    ...
    public CopyProductsBetweenWishlistsOutput setDestinationWishlist(Wishlist arg) {
    ...
    public CopyProductsBetweenWishlistsOutput setSourceWishlist(Wishlist arg) {
    ...
    public CopyProductsBetweenWishlistsOutput setUserErrors(List<WishListUserInputError> arg) {
