 ...
 */
public class SimpleWishlistItem extends AbstractResponse<SimpleWishlistItem> implements WishlistItemInterface {
    public SimpleWishlistItem() {}

    public SimpleWishlistItem(JsonObject fields) throws SchemaViolationError {
    ...
    public SimpleWishlistItem setAddedAt(String arg) {
    ...
    public SimpleWishlistItem setCustomizableOptions(List<SelectedCustomizableOption> arg) {
    ...
    public SimpleWishlistItem setDescription(String arg) {
    ...
    public SimpleWishlistItem setId(ID arg) {
    ...
    public SimpleWishlistItem setProduct(ProductInterface arg) {
    ...
    public SimpleWishlistItem setQuantity(Double arg) {
