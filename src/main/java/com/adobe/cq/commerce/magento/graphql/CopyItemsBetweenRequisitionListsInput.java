 ...
 */
public class CopyItemsBetweenRequisitionListsInput implements Serializable {
    private List<ID> requisitionListItemUids;

    private Map<String, Input<Serializable>> customFilters = new HashMap<>();

    public CopyItemsBetweenRequisitionListsInput(List<ID> requisitionListItemUids) {
     ...
     * An array of IDs representing products copied from one requisition list to another.
     */
    public CopyItemsBetweenRequisitionListsInput setRequisitionListItemUids(List<ID> requisitionListItemUids) {
        this.requisitionListItemUids = requisitionListItemUids;
        return this;
    }
     ...
     * Set custom filter.
     */
    public CopyItemsBetweenRequisitionListsInput setCustomFilter(String name, Serializable filterInput) {
