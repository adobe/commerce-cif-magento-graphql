...
public class HostedProUrlQuery extends AbstractQuery<HostedProUrlQuery> {
     ...
     */
    public static Fragment<HostedProUrlQuery> createFragment(String name, HostedProUrlQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new HostedProUrlQuery(sb));
        return new Fragment<>(name, "HostedProUrl", sb.toString());
    }

    /**
     * Adds a <code>HostedProUrlQuery</code> fragment reference at the current position of the query.
