...
public class ReturnCommentQuery extends AbstractQuery<ReturnCommentQuery> {
     ...
     */
    public static Fragment<ReturnCommentQuery> createFragment(String name, ReturnCommentQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new ReturnCommentQuery(sb));
        return new Fragment<>(name, "ReturnComment", sb.toString());
    }

    /**
     * Adds a <code>ReturnCommentQuery</code> fragment reference at the current position of the query.
