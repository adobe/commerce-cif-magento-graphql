...
public class GiftRegistryItem extends AbstractResponse<GiftRegistryItem> implements GiftRegistryItemInterface {
    public GiftRegistryItem() {}

    public GiftRegistryItem(JsonObject fields) throws SchemaViolationError {
    ...
    public GiftRegistryItem setCreatedAt(String arg) {
    ...
    public GiftRegistryItem setNote(String arg) {
    ...
    public GiftRegistryItem setProduct(ProductInterface arg) {
    ...
    public GiftRegistryItem setQuantity(Double arg) {
    ...
    public GiftRegistryItem setQuantityFulfilled(Double arg) {
    ...
    public GiftRegistryItem setUid(ID arg) {
