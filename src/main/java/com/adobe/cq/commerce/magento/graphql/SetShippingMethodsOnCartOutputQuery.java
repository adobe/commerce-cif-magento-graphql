...
public class SetShippingMethodsOnCartOutputQuery extends AbstractQuery<SetShippingMethodsOnCartOutputQuery> {
    ...
    /**
     * Adds a <code>SetShippingMethodsOnCartOutputQuery</code> fragment reference at the current position of the query.
     ...
     */
    public SetShippingMethodsOnCartOutputQuery addFragmentReference(Fragment<SetShippingMethodsOnCartOutputQuery> fragment) {
