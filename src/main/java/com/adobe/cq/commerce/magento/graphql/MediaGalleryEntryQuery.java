...
public class MediaGalleryEntryQuery extends AbstractQuery<MediaGalleryEntryQuery> {
     ...
     */
    public static Fragment<MediaGalleryEntryQuery> createFragment(String name, MediaGalleryEntryQueryDefinition queryDef) {
    ...
    /**
     * Adds a <code>MediaGalleryEntryQuery</code> fragment reference at the current position of the query.
