 ...
 */
public class CreateCompanyOutput extends AbstractResponse<CreateCompanyOutput> {
    public CreateCompanyOutput() {}

    public CreateCompanyOutput(JsonObject fields) throws SchemaViolationError {
    ...
    public CreateCompanyOutput setCompany(Company arg) {
