 ...
 */
public class GiftRegistryItemUserErrors extends AbstractResponse<GiftRegistryItemUserErrors> implements GiftRegistryItemUserErrorInterface {
    public GiftRegistryItemUserErrors() {}

    public GiftRegistryItemUserErrors(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "GiftRegistryItemUserErrors";
    }
    ...
    public GiftRegistryItemUserErrors setStatus(Boolean arg) {
    ...
    public GiftRegistryItemUserErrors setUserErrors(List<GiftRegistryItemsUserError> arg) {
