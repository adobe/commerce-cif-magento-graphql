...
public class ReturnCustomAttributeQuery extends AbstractQuery<ReturnCustomAttributeQuery> {
     ...
     */
    public static Fragment<ReturnCustomAttributeQuery> createFragment(String name, ReturnCustomAttributeQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new ReturnCustomAttributeQuery(sb));
        return new Fragment<>(name, "ReturnCustomAttribute", sb.toString());
    }

    /**
     * Adds a <code>ReturnCustomAttributeQuery</code> fragment reference at the current position of the query.
