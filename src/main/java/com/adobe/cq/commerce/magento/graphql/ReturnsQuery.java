...
public class ReturnsQuery extends AbstractQuery<ReturnsQuery> {
     ...
     */
    public static Fragment<ReturnsQuery> createFragment(String name, ReturnsQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new ReturnsQuery(sb));
        return new Fragment<>(name, "Returns", sb.toString());
    }

    /**
     * Adds a <code>ReturnsQuery</code> fragment reference at the current position of the query.
