...
public class CompanyRolesQuery extends AbstractQuery<CompanyRolesQuery> {
    CompanyRolesQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
     ...
     */
    public CompanyRolesQuery items(CompanyRoleQueryDefinition queryDef) {
        startField("items");
     ...
     * Pagination metadata.
     */
    public CompanyRolesQuery pageInfo(SearchResultPageInfoQueryDefinition queryDef) {
     ...
     */
    public static Fragment<CompanyRolesQuery> createFragment(String name, CompanyRolesQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new CompanyRolesQuery(sb));
        return new Fragment<>(name, "CompanyRoles", sb.toString());
    }

    /**
     * Adds a <code>CompanyRolesQuery</code> fragment reference at the current position of the query.
