...
public class CopyItemsFromRequisitionListsOutputQuery extends AbstractQuery<CopyItemsFromRequisitionListsOutputQuery> {
    CopyItemsFromRequisitionListsOutputQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
     ...
     */
    public CopyItemsFromRequisitionListsOutputQuery requisitionList(RequisitionListQueryDefinition queryDef) {
     ...
     */
    public static Fragment<CopyItemsFromRequisitionListsOutputQuery> createFragment(String name,
        CopyItemsFromRequisitionListsOutputQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new CopyItemsFromRequisitionListsOutputQuery(sb));
        return new Fragment<>(name, "CopyItemsFromRequisitionListsOutput", sb.toString());
    }

    /**
     * Adds a <code>CopyItemsFromRequisitionListsOutputQuery</code> fragment reference at the current position of the query.
