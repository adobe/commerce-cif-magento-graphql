...
public class ReturnCustomer extends AbstractResponse<ReturnCustomer> {
    ...
    public ReturnCustomer(JsonObject fields) throws SchemaViolationError {
    ...
    public ReturnCustomer setEmail(String arg) {
    ...
    public ReturnCustomer setFirstname(String arg) {
    ...
    public ReturnCustomer setLastname(String arg) {
