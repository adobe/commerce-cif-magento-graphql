...
public class CustomerAddressAttributeQuery extends AbstractQuery<CustomerAddressAttributeQuery> {
     ...
     */
    public static Fragment<CustomerAddressAttributeQuery> createFragment(String name, CustomerAddressAttributeQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new CustomerAddressAttributeQuery(sb));
        return new Fragment<>(name, "CustomerAddressAttribute", sb.toString());
    }

    /**
     * Adds a <code>CustomerAddressAttributeQuery</code> fragment reference at the current position of the query.
