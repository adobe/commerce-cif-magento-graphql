...
public class GroupedProduct extends AbstractResponse<GroupedProduct> implements PhysicalProductInterface, ProductInterface {
    ...
    */
    ...
    public GroupedProduct setDescription(String arg) {
    ...
    */
    ...
    public GroupedProduct setImage(String arg) {
    ...
    */
    ...
    public GroupedProduct setImageLabel(String arg) {
    ...
    */
    ...
    public GroupedProduct setShortDescription(String arg) {
    ...
    */
    ...
    public GroupedProduct setSmallImage(String arg) {
    ...
    */
    ...
    public GroupedProduct setSmallImageLabel(String arg) {
    ...
    */
    ...
    public GroupedProduct setThumbnail(String arg) {
    ...
    */
    ...
    public GroupedProduct setThumbnailLabel(String arg) {
