...
public class DownloadableItemsLinksQuery extends AbstractQuery<DownloadableItemsLinksQuery> {
     ...
     */
    public static Fragment<DownloadableItemsLinksQuery> createFragment(String name, DownloadableItemsLinksQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new DownloadableItemsLinksQuery(sb));
        return new Fragment<>(name, "DownloadableItemsLinks", sb.toString());
    }

    /**
     * Adds a <code>DownloadableItemsLinksQuery</code> fragment reference at the current position of the query.
