...
public class DownloadableProduct extends AbstractResponse<DownloadableProduct> implements CustomizableProductInterface, ProductInterface {
    ...
    public DownloadableProduct setIsReturnable(String arg) {
    ...
    public DownloadableProduct setRatingSummary(Double arg) {
    ...
    public DownloadableProduct setReviewCount(Integer arg) {
    ...
    public DownloadableProduct setReviews(ProductReviews arg) {
