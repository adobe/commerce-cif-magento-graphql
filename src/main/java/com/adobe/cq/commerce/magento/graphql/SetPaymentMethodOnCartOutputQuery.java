...
public class SetPaymentMethodOnCartOutputQuery extends AbstractQuery<SetPaymentMethodOnCartOutputQuery> {
    ...
    /**
     * Adds a <code>SetPaymentMethodOnCartOutputQuery</code> fragment reference at the current position of the query.
     ...
     */
    public SetPaymentMethodOnCartOutputQuery addFragmentReference(Fragment<SetPaymentMethodOnCartOutputQuery> fragment) {
