...
public class CustomizableDateValueQuery extends AbstractQuery<CustomizableDateValueQuery> {
     ...
     */
    public static Fragment<CustomizableDateValueQuery> createFragment(String name, CustomizableDateValueQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new CustomizableDateValueQuery(sb));
        return new Fragment<>(name, "CustomizableDateValue", sb.toString());
    }

    /**
     * Adds a <code>CustomizableDateValueQuery</code> fragment reference at the current position of the query.
