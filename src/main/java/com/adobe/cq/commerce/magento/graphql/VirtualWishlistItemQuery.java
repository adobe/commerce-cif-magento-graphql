...
public class VirtualWishlistItemQuery extends AbstractQuery<VirtualWishlistItemQuery> {
     ...
     */
    public static Fragment<VirtualWishlistItemQuery> createFragment(String name, VirtualWishlistItemQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new VirtualWishlistItemQuery(sb));
        return new Fragment<>(name, "VirtualWishlistItem", sb.toString());
    }

    /**
     * Adds a <code>VirtualWishlistItemQuery</code> fragment reference at the current position of the query.
     ...
     */
    public VirtualWishlistItemQuery addFragmentReference(Fragment<VirtualWishlistItemQuery> fragment) {
     ...
     * @param fragment The fragment to reference.
     */
    public VirtualWishlistItemQuery addWishlistItemInterfaceFragmentReference(Fragment<WishlistItemInterfaceQuery> fragment) {
        startField("..." + fragment.getName());
        return this;
    }
}
