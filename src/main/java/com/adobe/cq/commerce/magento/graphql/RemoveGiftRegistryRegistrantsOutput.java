...
public class RemoveGiftRegistryRegistrantsOutput extends AbstractResponse<RemoveGiftRegistryRegistrantsOutput> {
    ...
    public RemoveGiftRegistryRegistrantsOutput(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "RemoveGiftRegistryRegistrantsOutput";
    }
    ...
    public RemoveGiftRegistryRegistrantsOutput setGiftRegistry(GiftRegistry arg) {
