...
public class AddReturnCommentOutputQuery extends AbstractQuery<AddReturnCommentOutputQuery> {
     ...
     */
    public static Fragment<AddReturnCommentOutputQuery> createFragment(String name, AddReturnCommentOutputQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new AddReturnCommentOutputQuery(sb));
        return new Fragment<>(name, "AddReturnCommentOutput", sb.toString());
    }

    /**
     * Adds a <code>AddReturnCommentOutputQuery</code> fragment reference at the current position of the query.
