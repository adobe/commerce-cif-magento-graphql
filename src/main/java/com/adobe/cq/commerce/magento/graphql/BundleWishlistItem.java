...
public class BundleWishlistItem extends AbstractResponse<BundleWishlistItem> implements WishlistItemInterface {
    ...
    public BundleWishlistItem(JsonObject fields) throws SchemaViolationError {
        for (Map.Entry<String, JsonElement> field : fields.entrySet()) {
            ...
            switch (fieldName) {
                ...
                case "bundle_options": {
                    List<SelectedBundleOption> optional1 = null;
    ...
    public BundleWishlistItem setAddedAt(String arg) {
    ...
    public BundleWishlistItem setBundleOptions(List<SelectedBundleOption> arg) {
    ...
    public BundleWishlistItem setCustomizableOptions(List<SelectedCustomizableOption> arg) {
    ...
    public BundleWishlistItem setDescription(String arg) {
    ...
    public BundleWishlistItem setId(ID arg) {
    ...
    public BundleWishlistItem setProduct(ProductInterface arg) {
    ...
    public BundleWishlistItem setQuantity(Double arg) {
