...
public class RewardPointsExchangeRatesQuery extends AbstractQuery<RewardPointsExchangeRatesQuery> {
    ...
    public RewardPointsExchangeRatesQuery earning(RewardPointsRateQueryDefinition queryDef) {
        ...
        queryDef.define(new RewardPointsRateQuery(_queryBuilder));
        _queryBuilder.append('}');
     ...
     */
    public static Fragment<RewardPointsExchangeRatesQuery> createFragment(String name, RewardPointsExchangeRatesQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new RewardPointsExchangeRatesQuery(sb));
        return new Fragment<>(name, "RewardPointsExchangeRates", sb.toString());
    }

    /**
     * Adds a <code>RewardPointsExchangeRatesQuery</code> fragment reference at the current position of the query.
