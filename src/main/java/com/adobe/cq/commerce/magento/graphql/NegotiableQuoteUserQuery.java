...
public class NegotiableQuoteUserQuery extends AbstractQuery<NegotiableQuoteUserQuery> {
    NegotiableQuoteUserQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
     ...
     */
    public static Fragment<NegotiableQuoteUserQuery> createFragment(String name, NegotiableQuoteUserQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new NegotiableQuoteUserQuery(sb));
        return new Fragment<>(name, "NegotiableQuoteUser", sb.toString());
    }

    /**
     * Adds a <code>NegotiableQuoteUserQuery</code> fragment reference at the current position of the query.
