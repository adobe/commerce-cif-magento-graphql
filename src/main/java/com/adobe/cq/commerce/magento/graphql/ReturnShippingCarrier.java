...
public class ReturnShippingCarrier extends AbstractResponse<ReturnShippingCarrier> {
    ...
    public ReturnShippingCarrier(JsonObject fields) throws SchemaViolationError {
    ...
    public ReturnShippingCarrier setLabel(String arg) {
    ...
    public ReturnShippingCarrier setUid(ID arg) {
