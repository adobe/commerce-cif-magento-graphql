...
public class AddReturnCommentOutput extends AbstractResponse<AddReturnCommentOutput> {
    ...
    public AddReturnCommentOutput(JsonObject fields) throws SchemaViolationError {
    ...
    public AddReturnCommentOutput setReturn(Return arg) {
