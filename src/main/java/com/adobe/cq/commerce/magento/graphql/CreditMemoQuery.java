...
public class CreditMemoQuery extends AbstractQuery<CreditMemoQuery> {
    ...
    public CreditMemoQuery items(CreditMemoItemInterfaceQueryDefinition queryDef) {
        ...
        _queryBuilder.append('{');
        queryDef.define(new CreditMemoItemInterfaceQuery(_queryBuilder));
        _queryBuilder.append('}');
    ...
    public CreditMemoQuery total(CreditMemoTotalQueryDefinition queryDef) {
        ...
        _queryBuilder.append('{');
        queryDef.define(new CreditMemoTotalQuery(_queryBuilder));
        _queryBuilder.append('}');
     ...
     */
    public static Fragment<CreditMemoQuery> createFragment(String name, CreditMemoQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new CreditMemoQuery(sb));
        return new Fragment<>(name, "CreditMemo", sb.toString());
    }

    /**
     * Adds a <code>CreditMemoQuery</code> fragment reference at the current position of the query.
