...
public class RemoveGiftRegistryOutputQuery extends AbstractQuery<RemoveGiftRegistryOutputQuery> {
     ...
     */
    public static Fragment<RemoveGiftRegistryOutputQuery> createFragment(String name, RemoveGiftRegistryOutputQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new RemoveGiftRegistryOutputQuery(sb));
        return new Fragment<>(name, "RemoveGiftRegistryOutput", sb.toString());
    }

    /**
     * Adds a <code>RemoveGiftRegistryOutputQuery</code> fragment reference at the current position of the query.
