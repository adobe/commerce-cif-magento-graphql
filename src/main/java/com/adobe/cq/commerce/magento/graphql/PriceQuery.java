...
public class PriceQuery extends AbstractQuery<PriceQuery> {
     ...
     */
    public static Fragment<PriceQuery> createFragment(String name, PriceQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new PriceQuery(sb));
        return new Fragment<>(name, "Price", sb.toString());
    }

    /**
     * Adds a <code>PriceQuery</code> fragment reference at the current position of the query.
