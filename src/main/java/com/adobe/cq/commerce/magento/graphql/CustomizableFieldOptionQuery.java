...
public class CustomizableFieldOptionQuery extends AbstractQuery<CustomizableFieldOptionQuery> {
     ...
     */
    public static Fragment<CustomizableFieldOptionQuery> createFragment(String name, CustomizableFieldOptionQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new CustomizableFieldOptionQuery(sb));
        return new Fragment<>(name, "CustomizableFieldOption", sb.toString());
    }

    /**
     * Adds a <code>CustomizableFieldOptionQuery</code> fragment reference at the current position of the query.
