...
public class SortFieldQuery extends AbstractQuery<SortFieldQuery> {
     ...
     */
    public static Fragment<SortFieldQuery> createFragment(String name, SortFieldQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new SortFieldQuery(sb));
        return new Fragment<>(name, "SortField", sb.toString());
    }

    /**
     * Adds a <code>SortFieldQuery</code> fragment reference at the current position of the query.
