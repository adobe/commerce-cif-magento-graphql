...
public class GiftCardInvoiceItem extends AbstractResponse<GiftCardInvoiceItem> implements InvoiceItemInterface {
    ...
    public GiftCardInvoiceItem setDiscounts(List<Discount> arg) {
    ...
    public GiftCardInvoiceItem setGiftCard(GiftCardItem arg) {
    ...
    public GiftCardInvoiceItem setId(ID arg) {
    ...
    public GiftCardInvoiceItem setOrderItem(OrderItemInterface arg) {
    ...
    public GiftCardInvoiceItem setProductName(String arg) {
    ...
    public GiftCardInvoiceItem setProductSalePrice(Money arg) {
    ...
    public GiftCardInvoiceItem setProductSku(String arg) {
    ...
    public GiftCardInvoiceItem setQuantityInvoiced(Double arg) {
