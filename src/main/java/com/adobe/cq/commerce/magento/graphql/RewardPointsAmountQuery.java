...
public class RewardPointsAmountQuery extends AbstractQuery<RewardPointsAmountQuery> {
    RewardPointsAmountQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
     ...
     */
    public static Fragment<RewardPointsAmountQuery> createFragment(String name, RewardPointsAmountQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new RewardPointsAmountQuery(sb));
        return new Fragment<>(name, "RewardPointsAmount", sb.toString());
    }

    /**
     * Adds a <code>RewardPointsAmountQuery</code> fragment reference at the current position of the query.
