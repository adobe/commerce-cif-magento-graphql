...
public class ConfigurableProduct extends AbstractResponse<ConfigurableProduct> implements CustomizableProductInterface,
    ...
    public ConfigurableProduct setIsReturnable(String arg) {
    ...
    public ConfigurableProduct setRatingSummary(Double arg) {
    ...
    public ConfigurableProduct setReviewCount(Integer arg) {
    ...
    public ConfigurableProduct setReviews(ProductReviews arg) {
