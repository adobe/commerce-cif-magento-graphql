...
public class LayerFilterItemInterfaceQuery extends AbstractQuery<LayerFilterItemInterfaceQuery> {
     ...
     */
    public static Fragment<LayerFilterItemInterfaceQuery> createFragment(String name, LayerFilterItemInterfaceQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new LayerFilterItemInterfaceQuery(sb, false));
        return new Fragment<>(name, "LayerFilterItemInterface", sb.toString());
    }
