...
public class UpdateGiftRegistryItemsOutputQuery extends AbstractQuery<UpdateGiftRegistryItemsOutputQuery> {
     ...
     */
    public static Fragment<UpdateGiftRegistryItemsOutputQuery> createFragment(String name,
        UpdateGiftRegistryItemsOutputQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new UpdateGiftRegistryItemsOutputQuery(sb));
        return new Fragment<>(name, "UpdateGiftRegistryItemsOutput", sb.toString());
    }

    /**
     * Adds a <code>UpdateGiftRegistryItemsOutputQuery</code> fragment reference at the current position of the query.
