 ...
 */
public class UpdateCompanyOutput extends AbstractResponse<UpdateCompanyOutput> {
    public UpdateCompanyOutput() {}

    public UpdateCompanyOutput(JsonObject fields) throws SchemaViolationError {
    ...
    public UpdateCompanyOutput setCompany(Company arg) {
