...
public class SwatchDataInterfaceQuery extends AbstractQuery<SwatchDataInterfaceQuery> {
     ...
     */
    public static Fragment<SwatchDataInterfaceQuery> createFragment(String name, SwatchDataInterfaceQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new SwatchDataInterfaceQuery(sb, false));
        return new Fragment<>(name, "SwatchDataInterface", sb.toString());
    }
