...
public class UpdateCartItemsOutputQuery extends AbstractQuery<UpdateCartItemsOutputQuery> {
     ...
     */
    public static Fragment<UpdateCartItemsOutputQuery> createFragment(String name, UpdateCartItemsOutputQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new UpdateCartItemsOutputQuery(sb));
        return new Fragment<>(name, "UpdateCartItemsOutput", sb.toString());
    }

    /**
     * Adds a <code>UpdateCartItemsOutputQuery</code> fragment reference at the current position of the query.
