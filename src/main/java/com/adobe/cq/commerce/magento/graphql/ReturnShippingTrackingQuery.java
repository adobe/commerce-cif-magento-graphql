...
public class ReturnShippingTrackingQuery extends AbstractQuery<ReturnShippingTrackingQuery> {
    ...
    public ReturnShippingTrackingQuery status(ReturnShippingTrackingStatusQueryDefinition queryDef) {
        ...
        _queryBuilder.append('{');
        queryDef.define(new ReturnShippingTrackingStatusQuery(_queryBuilder));
        _queryBuilder.append('}');
     ...
     */
    public static Fragment<ReturnShippingTrackingQuery> createFragment(String name, ReturnShippingTrackingQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new ReturnShippingTrackingQuery(sb));
        return new Fragment<>(name, "ReturnShippingTracking", sb.toString());
    }

    /**
     * Adds a <code>ReturnShippingTrackingQuery</code> fragment reference at the current position of the query.
