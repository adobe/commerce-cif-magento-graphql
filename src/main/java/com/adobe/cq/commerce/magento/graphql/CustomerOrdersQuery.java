...
public class CustomerOrdersQuery extends AbstractQuery<CustomerOrdersQuery> {
     ...
     */
    public static Fragment<CustomerOrdersQuery> createFragment(String name, CustomerOrdersQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new CustomerOrdersQuery(sb));
        return new Fragment<>(name, "CustomerOrders", sb.toString());
    }

    /**
     * Adds a <code>CustomerOrdersQuery</code> fragment reference at the current position of the query.
