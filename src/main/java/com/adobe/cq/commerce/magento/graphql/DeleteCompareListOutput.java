...
public class DeleteCompareListOutput extends AbstractResponse<DeleteCompareListOutput> {
    ...
    public DeleteCompareListOutput(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "DeleteCompareListOutput";
    }
    ...
    public DeleteCompareListOutput setResult(Boolean arg) {
