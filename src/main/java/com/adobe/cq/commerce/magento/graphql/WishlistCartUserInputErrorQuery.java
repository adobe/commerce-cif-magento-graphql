...
public class WishlistCartUserInputErrorQuery extends AbstractQuery<WishlistCartUserInputErrorQuery> {
     ...
     */
    public static Fragment<WishlistCartUserInputErrorQuery> createFragment(String name,
        WishlistCartUserInputErrorQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new WishlistCartUserInputErrorQuery(sb));
        return new Fragment<>(name, "WishlistCartUserInputError", sb.toString());
    }

    /**
     * Adds a <code>WishlistCartUserInputErrorQuery</code> fragment reference at the current position of the query.
