...
public class GiftRegistrySearchResultQuery extends AbstractQuery<GiftRegistrySearchResultQuery> {
     ...
     */
    public static Fragment<GiftRegistrySearchResultQuery> createFragment(String name, GiftRegistrySearchResultQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new GiftRegistrySearchResultQuery(sb));
        return new Fragment<>(name, "GiftRegistrySearchResult", sb.toString());
    }

    /**
     * Adds a <code>GiftRegistrySearchResultQuery</code> fragment reference at the current position of the query.
