...
public class ReturnShippingTrackingStatusQuery extends AbstractQuery<ReturnShippingTrackingStatusQuery> {
     ...
     */
    public static Fragment<ReturnShippingTrackingStatusQuery> createFragment(String name,
        ReturnShippingTrackingStatusQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new ReturnShippingTrackingStatusQuery(sb));
        return new Fragment<>(name, "ReturnShippingTrackingStatus", sb.toString());
    }

    /**
     * Adds a <code>ReturnShippingTrackingStatusQuery</code> fragment reference at the current position of the query.
