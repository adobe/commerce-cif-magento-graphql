...
public class RemoveReturnTrackingOutput extends AbstractResponse<RemoveReturnTrackingOutput> {
    ...
    public RemoveReturnTrackingOutput(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "RemoveReturnTrackingOutput";
    }
    ...
    public RemoveReturnTrackingOutput setReturn(Return arg) {
