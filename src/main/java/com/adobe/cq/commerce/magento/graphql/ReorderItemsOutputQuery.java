...
public class ReorderItemsOutputQuery extends AbstractQuery<ReorderItemsOutputQuery> {
     ...
     */
    public static Fragment<ReorderItemsOutputQuery> createFragment(String name, ReorderItemsOutputQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new ReorderItemsOutputQuery(sb));
        return new Fragment<>(name, "ReorderItemsOutput", sb.toString());
    }

    /**
     * Adds a <code>ReorderItemsOutputQuery</code> fragment reference at the current position of the query.
