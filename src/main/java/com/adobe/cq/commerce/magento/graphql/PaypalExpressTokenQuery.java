...
public class PaypalExpressTokenQuery extends AbstractQuery<PaypalExpressTokenQuery> {
     ...
     */
    public static Fragment<PaypalExpressTokenQuery> createFragment(String name, PaypalExpressTokenQueryDefinition queryDef) {
    ...
    /**
     * Adds a <code>PaypalExpressTokenQuery</code> fragment reference at the current position of the query.
