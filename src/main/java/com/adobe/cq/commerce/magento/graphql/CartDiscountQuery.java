...
public class CartDiscountQuery extends AbstractQuery<CartDiscountQuery> {
     ...
     */
    public static Fragment<CartDiscountQuery> createFragment(String name, CartDiscountQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new CartDiscountQuery(sb));
        return new Fragment<>(name, "CartDiscount", sb.toString());
    }

    /**
     * Adds a <code>CartDiscountQuery</code> fragment reference at the current position of the query.
