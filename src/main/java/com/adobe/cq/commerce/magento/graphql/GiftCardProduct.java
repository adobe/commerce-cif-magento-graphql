...
public class GiftCardProduct extends AbstractResponse<GiftCardProduct> implements CustomizableProductInterface, PhysicalProductInterface, ProductInterface {
    ...
    public boolean unwrapsToObject(String key) {
        switch (getFieldName(key)) {
            case "allow_message": return false;

            case "allow_open_amount": return false;
            ...
            case "gift_card_options": return false;

            case "gift_message_available": return false;

            case "giftcard_amounts": return true;

            case "giftcard_type": return false;

            case "id": return false;

            case "image": return true;

            case "is_redeemable": return false;
            ...
            case "message_max_length": return false;
            ...
            case "open_amount_max": return false;

            case "open_amount_min": return false;
