...
public class GiftRegistryItemUserErrorsQuery extends AbstractQuery<GiftRegistryItemUserErrorsQuery> {
     ...
     */
    public static Fragment<GiftRegistryItemUserErrorsQuery> createFragment(String name,
        GiftRegistryItemUserErrorsQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new GiftRegistryItemUserErrorsQuery(sb));
        return new Fragment<>(name, "GiftRegistryItemUserErrors", sb.toString());
    }

    /**
     * Adds a <code>GiftRegistryItemUserErrorsQuery</code> fragment reference at the current position of the query.
     ...
     * @param fragment The fragment to reference.
     */
    public GiftRegistryItemUserErrorsQuery addGiftRegistryItemUserErrorInterfaceFragmentReference(
