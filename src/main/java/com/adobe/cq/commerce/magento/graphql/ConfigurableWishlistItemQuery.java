...
public class ConfigurableWishlistItemQuery extends AbstractQuery<ConfigurableWishlistItemQuery> {
     ...
     */
    public static Fragment<ConfigurableWishlistItemQuery> createFragment(String name, ConfigurableWishlistItemQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new ConfigurableWishlistItemQuery(sb));
        return new Fragment<>(name, "ConfigurableWishlistItem", sb.toString());
    }

    /**
     * Adds a <code>ConfigurableWishlistItemQuery</code> fragment reference at the current position of the query.
