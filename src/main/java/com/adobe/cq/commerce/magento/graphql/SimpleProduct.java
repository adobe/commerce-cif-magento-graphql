...
public class SimpleProduct extends AbstractResponse<SimpleProduct> implements CustomizableProductInterface, PhysicalProductInterface,
    ...
    public SimpleProduct setFashionColor(Integer arg) {
    ...
    public SimpleProduct setFashionMaterial(String arg) {
    ...
    public SimpleProduct setFashionSize(Integer arg) {
    ...
    public SimpleProduct setFashionStyle(String arg) {
    ...
    public SimpleProduct setFormat(Integer arg) {
    ...
    public SimpleProduct setHasVideo(Integer arg) {
    ...
    public SimpleProduct setPurpose(Integer arg) {
    ...
    public SimpleProduct setRedirectCode(Integer arg) {
    ...
    public SimpleProduct setRelativeUrl(String arg) {
    ...
    public SimpleProduct setType(UrlRewriteEntityTypeEnum arg) {
    ...
    public SimpleProduct setVideoFile(String arg) {
