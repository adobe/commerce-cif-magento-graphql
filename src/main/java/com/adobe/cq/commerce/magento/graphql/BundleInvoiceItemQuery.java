...
public class BundleInvoiceItemQuery extends AbstractQuery<BundleInvoiceItemQuery> {
     ...
     */
    public static Fragment<BundleInvoiceItemQuery> createFragment(String name, BundleInvoiceItemQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new BundleInvoiceItemQuery(sb));
        return new Fragment<>(name, "BundleInvoiceItem", sb.toString());
    }

    /**
     * Adds a <code>BundleInvoiceItemQuery</code> fragment reference at the current position of the query.
     ...
     */
    public BundleInvoiceItemQuery addFragmentReference(Fragment<BundleInvoiceItemQuery> fragment) {
     ...
     * @param fragment The fragment to reference.
     */
    public BundleInvoiceItemQuery addInvoiceItemInterfaceFragmentReference(Fragment<InvoiceItemInterfaceQuery> fragment) {
        startField("..." + fragment.getName());
        return this;
    }
}
