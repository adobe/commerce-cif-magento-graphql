...
public class SendEmailToFriendSenderQuery extends AbstractQuery<SendEmailToFriendSenderQuery> {
     ...
     */
    public static Fragment<SendEmailToFriendSenderQuery> createFragment(String name, SendEmailToFriendSenderQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new SendEmailToFriendSenderQuery(sb));
        return new Fragment<>(name, "SendEmailToFriendSender", sb.toString());
    }

    /**
     * Adds a <code>SendEmailToFriendSenderQuery</code> fragment reference at the current position of the query.
