...
public class ProductReviewRatingsMetadataQuery extends AbstractQuery<ProductReviewRatingsMetadataQuery> {
    ...
    public ProductReviewRatingsMetadataQuery items(ProductReviewRatingMetadataQueryDefinition queryDef) {
        ...
        queryDef.define(new ProductReviewRatingMetadataQuery(_queryBuilder));
        _queryBuilder.append('}');
    ...
    /**
     * Adds a <code>ProductReviewRatingsMetadataQuery</code> fragment reference at the current position of the query.
     ...
     */
    public ProductReviewRatingsMetadataQuery addFragmentReference(Fragment<ProductReviewRatingsMetadataQuery> fragment) {
