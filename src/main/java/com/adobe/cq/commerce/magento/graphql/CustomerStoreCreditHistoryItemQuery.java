...
public class CustomerStoreCreditHistoryItemQuery extends AbstractQuery<CustomerStoreCreditHistoryItemQuery> {
     ...
     */
    public CustomerStoreCreditHistoryItemQuery balanceChange(MoneyQueryDefinition queryDef) {
    ...
    /**
     * Adds a <code>CustomerStoreCreditHistoryItemQuery</code> fragment reference at the current position of the query.
