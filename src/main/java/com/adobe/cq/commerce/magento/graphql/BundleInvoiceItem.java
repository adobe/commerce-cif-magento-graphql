...
public class BundleInvoiceItem extends AbstractResponse<BundleInvoiceItem> implements InvoiceItemInterface {
    ...
    public BundleInvoiceItem setBundleOptions(List<ItemSelectedBundleOption> arg) {
    ...
    public BundleInvoiceItem setDiscounts(List<Discount> arg) {
    ...
    public BundleInvoiceItem setId(ID arg) {
    ...
    public BundleInvoiceItem setOrderItem(OrderItemInterface arg) {
    ...
    public BundleInvoiceItem setProductName(String arg) {
    ...
    public BundleInvoiceItem setProductSalePrice(Money arg) {
    ...
    public BundleInvoiceItem setProductSku(String arg) {
    ...
    public BundleInvoiceItem setQuantityInvoiced(Double arg) {
