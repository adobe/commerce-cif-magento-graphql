...
public class GiftRegistryTypeQuery extends AbstractQuery<GiftRegistryTypeQuery> {
    ...
    public GiftRegistryTypeQuery dynamicAttributesMetadata(GiftRegistryDynamicAttributeMetadataInterfaceQueryDefinition queryDef) {
        ...
        queryDef.define(new GiftRegistryDynamicAttributeMetadataInterfaceQuery(_queryBuilder));
        _queryBuilder.append('}');
     ...
     */
    public static Fragment<GiftRegistryTypeQuery> createFragment(String name, GiftRegistryTypeQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new GiftRegistryTypeQuery(sb));
        return new Fragment<>(name, "GiftRegistryType", sb.toString());
    }

    /**
     * Adds a <code>GiftRegistryTypeQuery</code> fragment reference at the current position of the query.
