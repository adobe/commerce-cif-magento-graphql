...
public class GiftRegistryRegistrantQuery extends AbstractQuery<GiftRegistryRegistrantQuery> {
     ...
     */
    public static Fragment<GiftRegistryRegistrantQuery> createFragment(String name, GiftRegistryRegistrantQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new GiftRegistryRegistrantQuery(sb));
        return new Fragment<>(name, "GiftRegistryRegistrant", sb.toString());
    }

    /**
     * Adds a <code>GiftRegistryRegistrantQuery</code> fragment reference at the current position of the query.
