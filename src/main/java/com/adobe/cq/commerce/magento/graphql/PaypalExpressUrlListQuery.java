...
public class PaypalExpressUrlListQuery extends AbstractQuery<PaypalExpressUrlListQuery> {
     ...
     */
    public static Fragment<PaypalExpressUrlListQuery> createFragment(String name, PaypalExpressUrlListQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new PaypalExpressUrlListQuery(sb));
        return new Fragment<>(name, "PaypalExpressUrlList", sb.toString());
    }

    /**
     * Adds a <code>PaypalExpressUrlListQuery</code> fragment reference at the current position of the query.
