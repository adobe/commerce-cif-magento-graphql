...
public class CartAddressCountryQuery extends AbstractQuery<CartAddressCountryQuery> {
     ...
     */
    public static Fragment<CartAddressCountryQuery> createFragment(String name, CartAddressCountryQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new CartAddressCountryQuery(sb));
        return new Fragment<>(name, "CartAddressCountry", sb.toString());
    }

    /**
     * Adds a <code>CartAddressCountryQuery</code> fragment reference at the current position of the query.
