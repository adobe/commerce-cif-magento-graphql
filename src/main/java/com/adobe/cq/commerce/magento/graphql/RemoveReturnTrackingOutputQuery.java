...
public class RemoveReturnTrackingOutputQuery extends AbstractQuery<RemoveReturnTrackingOutputQuery> {
     ...
     */
    public static Fragment<RemoveReturnTrackingOutputQuery> createFragment(String name,
        RemoveReturnTrackingOutputQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new RemoveReturnTrackingOutputQuery(sb));
        return new Fragment<>(name, "RemoveReturnTrackingOutput", sb.toString());
    }

    /**
     * Adds a <code>RemoveReturnTrackingOutputQuery</code> fragment reference at the current position of the query.
