...
public class GiftCardRequisitionListItemQuery extends AbstractQuery<GiftCardRequisitionListItemQuery> {
    GiftCardRequisitionListItemQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
     ...
     */
    public GiftCardRequisitionListItemQuery customizableOptions(SelectedCustomizableOptionQueryDefinition queryDef) {
     ...
     */
    public GiftCardRequisitionListItemQuery giftCardOptions(GiftCardOptionsQueryDefinition queryDef) {
     ...
     */
    public GiftCardRequisitionListItemQuery product(ProductInterfaceQueryDefinition queryDef) {
        startField("product");
     ...
     */
    public static Fragment<GiftCardRequisitionListItemQuery> createFragment(String name,
        GiftCardRequisitionListItemQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new GiftCardRequisitionListItemQuery(sb));
        return new Fragment<>(name, "GiftCardRequisitionListItem", sb.toString());
    }

    /**
     * Adds a <code>GiftCardRequisitionListItemQuery</code> fragment reference at the current position of the query.
     ...
     * @param fragment The fragment to reference.
     */
    public GiftCardRequisitionListItemQuery addRequisitionListItemInterfaceFragmentReference(
