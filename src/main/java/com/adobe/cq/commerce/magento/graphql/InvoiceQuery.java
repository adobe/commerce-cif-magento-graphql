...
public class InvoiceQuery extends AbstractQuery<InvoiceQuery> {
    ...
    public InvoiceQuery items(InvoiceItemInterfaceQueryDefinition queryDef) {
        ...
        _queryBuilder.append('{');
        queryDef.define(new InvoiceItemInterfaceQuery(_queryBuilder));
        _queryBuilder.append('}');
    ...
    public InvoiceQuery total(InvoiceTotalQueryDefinition queryDef) {
        ...
        _queryBuilder.append('{');
        queryDef.define(new InvoiceTotalQuery(_queryBuilder));
        _queryBuilder.append('}');
     ...
     */
    public static Fragment<InvoiceQuery> createFragment(String name, InvoiceQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new InvoiceQuery(sb));
        return new Fragment<>(name, "Invoice", sb.toString());
    }

    /**
     * Adds a <code>InvoiceQuery</code> fragment reference at the current position of the query.
