...
public class OrderShipmentQuery extends AbstractQuery<OrderShipmentQuery> {
    ...
    public OrderShipmentQuery items(ShipmentItemInterfaceQueryDefinition queryDef) {
        ...
        _queryBuilder.append('{');
        queryDef.define(new ShipmentItemInterfaceQuery(_queryBuilder));
        _queryBuilder.append('}');
    ...
    public OrderShipmentQuery tracking(ShipmentTrackingQueryDefinition queryDef) {
        ...
        _queryBuilder.append('{');
        queryDef.define(new ShipmentTrackingQuery(_queryBuilder));
        _queryBuilder.append('}');
     ...
     */
    public static Fragment<OrderShipmentQuery> createFragment(String name, OrderShipmentQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new OrderShipmentQuery(sb));
        return new Fragment<>(name, "OrderShipment", sb.toString());
    }

    /**
     * Adds a <code>OrderShipmentQuery</code> fragment reference at the current position of the query.
