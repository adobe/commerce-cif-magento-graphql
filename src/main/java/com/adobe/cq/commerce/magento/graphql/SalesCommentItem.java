...
public class SalesCommentItem extends AbstractResponse<SalesCommentItem> {
    ...
    public SalesCommentItem setMessage(String arg) {
    ...
    public SalesCommentItem setTimestamp(String arg) {
        optimisticData.put(getKey("timestamp"), arg);
        return this;
    }
