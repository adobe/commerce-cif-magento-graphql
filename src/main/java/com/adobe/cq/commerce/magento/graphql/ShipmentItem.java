...
public class ShipmentItem extends AbstractResponse<ShipmentItem> implements ShipmentItemInterface {
    ...
    public ShipmentItem setId(ID arg) {
    ...
    public ShipmentItem setOrderItem(OrderItemInterface arg) {
    ...
    public ShipmentItem setProductName(String arg) {
    ...
    public ShipmentItem setProductSalePrice(Money arg) {
    ...
    public ShipmentItem setProductSku(String arg) {
    ...
    public ShipmentItem setQuantityShipped(Double arg) {
