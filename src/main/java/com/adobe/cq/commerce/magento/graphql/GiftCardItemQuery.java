...
public class GiftCardItemQuery extends AbstractQuery<GiftCardItemQuery> {
     ...
     */
    public static Fragment<GiftCardItemQuery> createFragment(String name, GiftCardItemQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new GiftCardItemQuery(sb));
        return new Fragment<>(name, "GiftCardItem", sb.toString());
    }

    /**
     * Adds a <code>GiftCardItemQuery</code> fragment reference at the current position of the query.
