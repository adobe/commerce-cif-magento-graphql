...
public class ConfigurableOptionAvailableForSelectionQuery extends AbstractQuery<ConfigurableOptionAvailableForSelectionQuery> {
     ...
     */
    public static Fragment<ConfigurableOptionAvailableForSelectionQuery> createFragment(String name,
        ConfigurableOptionAvailableForSelectionQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new ConfigurableOptionAvailableForSelectionQuery(sb));
        return new Fragment<>(name, "ConfigurableOptionAvailableForSelection", sb.toString());
    }

    /**
     * Adds a <code>ConfigurableOptionAvailableForSelectionQuery</code> fragment reference at the current position of the query.
     ...
     */
    public ConfigurableOptionAvailableForSelectionQuery addFragmentReference(
        Fragment<ConfigurableOptionAvailableForSelectionQuery> fragment) {
