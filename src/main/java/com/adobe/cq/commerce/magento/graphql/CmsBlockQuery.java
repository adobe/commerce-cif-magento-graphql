...
public class CmsBlockQuery extends AbstractQuery<CmsBlockQuery> {
     ...
     */
    public static Fragment<CmsBlockQuery> createFragment(String name, CmsBlockQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new CmsBlockQuery(sb));
        return new Fragment<>(name, "CmsBlock", sb.toString());
    }

    /**
     * Adds a <code>CmsBlockQuery</code> fragment reference at the current position of the query.
