...
public class GroupedProductWishlistItemQuery extends AbstractQuery<GroupedProductWishlistItemQuery> {
     ...
     */
    public static Fragment<GroupedProductWishlistItemQuery> createFragment(String name,
        GroupedProductWishlistItemQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new GroupedProductWishlistItemQuery(sb));
        return new Fragment<>(name, "GroupedProductWishlistItem", sb.toString());
    }

    /**
     * Adds a <code>GroupedProductWishlistItemQuery</code> fragment reference at the current position of the query.
