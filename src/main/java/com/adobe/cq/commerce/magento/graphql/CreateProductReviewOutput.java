...
public class CreateProductReviewOutput extends AbstractResponse<CreateProductReviewOutput> {
    ...
    public CreateProductReviewOutput(JsonObject fields) throws SchemaViolationError {
        for (Map.Entry<String, JsonElement> field : fields.entrySet()) {
            ...
            switch (fieldName) {
                case "review": {
                    responseData.put(key, new ProductReview(jsonAsObject(field.getValue(), key)));
    ...
    public String getGraphQlTypeName() {
        return "CreateProductReviewOutput";
    }
    ...
    public CreateProductReviewOutput setReview(ProductReview arg) {
