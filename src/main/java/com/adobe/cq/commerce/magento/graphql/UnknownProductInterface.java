...
public class UnknownProductInterface extends AbstractResponse<UnknownProductInterface> implements ProductInterface {
    ...
    public UnknownProductInterface setFashionColor(Integer arg) {
    ...
    public UnknownProductInterface setFashionMaterial(String arg) {
    ...
    public UnknownProductInterface setFashionSize(Integer arg) {
    ...
    public UnknownProductInterface setFashionStyle(String arg) {
    ...
    public UnknownProductInterface setFormat(Integer arg) {
    ...
    public UnknownProductInterface setHasVideo(Integer arg) {
    ...
    public UnknownProductInterface setPurpose(Integer arg) {
    ...
    public UnknownProductInterface setStaged(Boolean arg) {
    ...
    public UnknownProductInterface setUid(ID arg) {
    ...
    public UnknownProductInterface setVideoFile(String arg) {
