...
public class InvoiceItem extends AbstractResponse<InvoiceItem> implements InvoiceItemInterface {
    ...
    public InvoiceItem setDiscounts(List<Discount> arg) {
    ...
    public InvoiceItem setId(ID arg) {
    ...
    public InvoiceItem setOrderItem(OrderItemInterface arg) {
    ...
    public InvoiceItem setProductName(String arg) {
    ...
    public InvoiceItem setProductSalePrice(Money arg) {
    ...
    public InvoiceItem setProductSku(String arg) {
    ...
    public InvoiceItem setQuantityInvoiced(Double arg) {
