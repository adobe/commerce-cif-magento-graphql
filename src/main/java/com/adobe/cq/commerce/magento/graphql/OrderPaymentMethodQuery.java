...
public class OrderPaymentMethodQuery extends AbstractQuery<OrderPaymentMethodQuery> {
    ...
    public OrderPaymentMethodQuery additionalData(KeyValueQueryDefinition queryDef) {
        ...
        queryDef.define(new KeyValueQuery(_queryBuilder));
        _queryBuilder.append('}');
     ...
     */
    public static Fragment<OrderPaymentMethodQuery> createFragment(String name, OrderPaymentMethodQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new OrderPaymentMethodQuery(sb));
        return new Fragment<>(name, "OrderPaymentMethod", sb.toString());
    }

    /**
     * Adds a <code>OrderPaymentMethodQuery</code> fragment reference at the current position of the query.
