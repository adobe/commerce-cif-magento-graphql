...
public class WishlistOutputQuery extends AbstractQuery<WishlistOutputQuery> {
     ...
     */
    public static Fragment<WishlistOutputQuery> createFragment(String name, WishlistOutputQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new WishlistOutputQuery(sb));
        return new Fragment<>(name, "WishlistOutput", sb.toString());
    }

    /**
     * Adds a <code>WishlistOutputQuery</code> fragment reference at the current position of the query.
