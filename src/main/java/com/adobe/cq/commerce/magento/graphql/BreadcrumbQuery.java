...
public class BreadcrumbQuery extends AbstractQuery<BreadcrumbQuery> {
     ...
     */
    public static Fragment<BreadcrumbQuery> createFragment(String name, BreadcrumbQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new BreadcrumbQuery(sb));
        return new Fragment<>(name, "Breadcrumb", sb.toString());
    }

    /**
     * Adds a <code>BreadcrumbQuery</code> fragment reference at the current position of the query.
