...
public class RewardPointsExchangeRates extends AbstractResponse<RewardPointsExchangeRates> {
    ...
    public RewardPointsExchangeRates(JsonObject fields) throws SchemaViolationError {
        for (Map.Entry<String, JsonElement> field : fields.entrySet()) {
            ...
            switch (fieldName) {
                case "earning": {
                    RewardPointsRate optional1 = null;
                    if (!field.getValue().isJsonNull()) {
                        optional1 = new RewardPointsRate(jsonAsObject(field.getValue(), key));
                    }
    ...
    public String getGraphQlTypeName() {
        return "RewardPointsExchangeRates";
    }
    ...
    public RewardPointsExchangeRates setEarning(RewardPointsRate arg) {
        optimisticData.put(getKey("earning"), arg);
        return this;
    }
    ...
    public RewardPointsExchangeRates setRedemption(RewardPointsRate arg) {
        optimisticData.put(getKey("redemption"), arg);
        return this;
    }
