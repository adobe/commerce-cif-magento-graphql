...
public class InvoiceTotal extends AbstractResponse<InvoiceTotal> {
    ...
    public InvoiceTotal setBaseGrandTotal(Money arg) {
    ...
    public InvoiceTotal setDiscounts(List<Discount> arg) {
    ...
    public InvoiceTotal setGrandTotal(Money arg) {
    ...
    public InvoiceTotal setShippingHandling(ShippingHandling arg) {
    ...
    public InvoiceTotal setSubtotal(Money arg) {
    ...
    public InvoiceTotal setTaxes(List<TaxItem> arg) {
    ...
    public InvoiceTotal setTotalShipping(Money arg) {
    ...
    public InvoiceTotal setTotalTax(Money arg) {
