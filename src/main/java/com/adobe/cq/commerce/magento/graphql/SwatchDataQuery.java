...
public class SwatchDataQuery extends AbstractQuery<SwatchDataQuery> {
     ...
     */
    public static Fragment<SwatchDataQuery> createFragment(String name, SwatchDataQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new SwatchDataQuery(sb));
        return new Fragment<>(name, "SwatchData", sb.toString());
    }

    /**
     * Adds a <code>SwatchDataQuery</code> fragment reference at the current position of the query.
