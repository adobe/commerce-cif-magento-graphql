...
public class SetGuestEmailOnCartOutputQuery extends AbstractQuery<SetGuestEmailOnCartOutputQuery> {
     ...
     */
    public static Fragment<SetGuestEmailOnCartOutputQuery> createFragment(String name, SetGuestEmailOnCartOutputQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new SetGuestEmailOnCartOutputQuery(sb));
        return new Fragment<>(name, "SetGuestEmailOnCartOutput", sb.toString());
    }

    /**
     * Adds a <code>SetGuestEmailOnCartOutputQuery</code> fragment reference at the current position of the query.
