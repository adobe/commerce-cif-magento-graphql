...
public class SubscribeEmailToNewsletterOutputQuery extends AbstractQuery<SubscribeEmailToNewsletterOutputQuery> {
    ...
    /**
     * Adds a <code>SubscribeEmailToNewsletterOutputQuery</code> fragment reference at the current position of the query.
     ...
     */
    public SubscribeEmailToNewsletterOutputQuery addFragmentReference(Fragment<SubscribeEmailToNewsletterOutputQuery> fragment) {
