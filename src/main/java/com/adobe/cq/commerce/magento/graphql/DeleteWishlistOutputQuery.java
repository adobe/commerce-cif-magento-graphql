...
public class DeleteWishlistOutputQuery extends AbstractQuery<DeleteWishlistOutputQuery> {
     ...
     */
    public static Fragment<DeleteWishlistOutputQuery> createFragment(String name, DeleteWishlistOutputQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new DeleteWishlistOutputQuery(sb));
        return new Fragment<>(name, "DeleteWishlistOutput", sb.toString());
    }

    /**
     * Adds a <code>DeleteWishlistOutputQuery</code> fragment reference at the current position of the query.
