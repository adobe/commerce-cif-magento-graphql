...
public class CustomerAddressRegionQuery extends AbstractQuery<CustomerAddressRegionQuery> {
     ...
     */
    public static Fragment<CustomerAddressRegionQuery> createFragment(String name, CustomerAddressRegionQueryDefinition queryDef) {
        StringBuilder sb = new StringBuilder();
        queryDef.define(new CustomerAddressRegionQuery(sb));
        return new Fragment<>(name, "CustomerAddressRegion", sb.toString());
    }

    /**
     * Adds a <code>CustomerAddressRegionQuery</code> fragment reference at the current position of the query.
